        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Createtime = table.Column<TimeOnly>(type: "time(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonorNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DonorNotifications_Donors_DonorId",
                        column: x => x.DonorId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FoodListings_Donors_DonorId",
                        column: x => x.DonorId,
                        principalTable: "Donors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CreatedDate = table.Column<DateOnly>(type: "date", nullable: false),
                    CreatedTime = table.Column<TimeOnly>(type: "time(6)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipientNotifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipientNotifications_Recipients_RecipientId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataReceived = table.Column<DateOnly>(type: "date", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DonationHistories", x => x.DonationId);
                    table.ForeignKey(
                        name: "FK_DonationHistories_FoodListings_FoodListingId",
                        column: x => x.FoodListingId,
                        principalTable: "FoodListings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DonationHistories_Recipients_RecipientId",
                        column: x => x.RecipientId,
                        principalTable: "Recipients",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DonationHistories_FoodListingId",
                table: "DonationHistories",
                column: "FoodListingId");

            migrationBuilder.CreateIndex(
                name: "IX_DonationHistories_RecipientId",
                table: "DonationHistories",
                column: "RecipientId");

            migrationBuilder.CreateIndex(
                name: "IX_DonorNotifications_DonorId",
                table: "DonorNotifications",
                column: "DonorId");

            migrationBuilder.CreateIndex(
                name: "IX_FoodListings_DonorId",
                table: "FoodListings",
                column: "DonorId");

            migrationBuilder.CreateIndex(
                name: "IX_RecipientNotifications_RecipientId",
                table: "RecipientNotifications",
                column: "RecipientId");
        }
